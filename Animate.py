...
class Animate:
    ...
    def calc_then_show(self) -> None:
        ...
        # Run the system for however many timesteps were given.
        ...
        # Draw arrows for balls' velocities (currently borked).
        ...
        # Some wierd matplotlib stuff that we need for some reason.
        ...
        # For every frame in the system's history...
        for frame, state in enumerate(self.system.history):
            ...
            # Some more wierd matplotlib stuff that we need for some reason.
            fig.canvas.blit(fig.bbox)
